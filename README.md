...
| `flask_nginx` | реверс-прокси, TLS | 80 / 443 |
...
> том же хосте (например, с Xray-ядром ноды, которое обычно занимает 443),
> разведите порты 80/443/8000/8081 или вынесите на отдельный сервер.
